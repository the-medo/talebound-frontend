        ...
        <RegisterBox>
          ...
          <RegisterCheckbox size="md" onChange={handleCheckbox}>
            <Text size="xs" color="$white">
              I agree to the <ClickableSpan onClick={handleTOS}>Terms of Service</ClickableSpan> and
              I have read the <ClickableSpan onClick={handlePrivacy}>Privacy Policy</ClickableSpan>
            </Text>
          </RegisterCheckbox>
          <div>
            <Button
