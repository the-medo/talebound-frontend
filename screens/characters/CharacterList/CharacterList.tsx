...
import ActionBoxCharacterList from './ActionBoxCharacterList';
      ...
      <Layout vertical={true} navbar={<LeftNavbar />}>
        <Row gap="md" alignItems="start" wrap>
          <Col css={{ flexGrow: 5, flexBasis: '10rem' }}>
            ...
            <Row gap="md" alignItems="start" wrap>
              {charactersData?.pages.map(
                (page) =>
                  page.characterIds?.map((characterId) => (
                    <Suspense fallback={null} key={characterId}>
          ...
          <Col css={{ flexGrow: 0, flexBasis: '600px' }}>
            <ContentSection direction="column" header="Characters">
              <p>
