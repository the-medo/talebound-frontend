    ...
    <Container css={{ padding: '$10' }}>
      <Row>
        <Col offset={offset} span={12 - 2 * offset}>
          ...
          <Text>
            At Talebound, we take your privacy seriously. This Privacy Policy outlines how we
          ...
          <ol>
            ...
            <Text>
              We collect personal information when you register for an account on Talebound,
              including your email address. We also collect information on your usage of our website
              and services, such as the worlds you create, the characters you play, and your
            ...
            <Text>
              ...
              required by law or to protect the safety, rights, or property of Talebound or our
              users.
            </Text>
            <br />
            ...
            <Text>
              ...
              this page, and we encourage you to review this policy periodically to stay informed
