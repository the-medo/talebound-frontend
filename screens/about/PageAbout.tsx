    ...
    <Container css={{padding: '$10'}}>
      <Row>
        <Col offset={3} span={6}>
          ...
          <Text>Welcome to Talebound, the premier platform for text-based role-playing games and immersive storytelling experiences. Our mission is to bring together storytellers, dungeon masters, and role-players from around the world to create, share, and explore captivating stories and extraordinary worlds.</Text><br/>
          ...
          <Text>Join us in our quest to explore the boundless realms of imagination and create unforgettable stories. Sign up today and become a part of the Talebound family. Your story awaits!</Text>
