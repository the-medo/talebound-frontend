    ...
    <Container css={{ padding: '$10' }}>
      <Row>
        <Col offset={offset} span={12 - 2 * offset}>
          ...
          <Text>
            By using the Talebound website and services, you agree to be bound by the following
            Terms of Service:
          </Text>
          <ol>
            <li>
            ...
            <Text>
              You retain ownership of the content you create on Talebound. By using our services,
              you grant Talebound a non-exclusive, royalty-free, worldwide license to use, display,
            ...
            <Text>
              Talebound is provided &quot;as is&quot; and without warranties of any kind. We shall
              not be liable for any damages, including direct, indirect, incidental, or
              consequential damages, arising out of the use or inability to use our website or
              services.
            </Text>
            <br />
            ...
            <Text>
              We reserve the right to terminate your access to Talebound at any time, with or
